...
export default merge(prodEnv, {
    NODE_ENV: NODE_ENV,
    LOCAL_DEV_URL: JSON.stringify('http://dev.bkapp.tencent.com'),
    LOCAL_DEV_PORT: JSON.stringify('8080'),
    AJAX_URL_PREFIX: JSON.stringify('http://dev.bkapp.tencent.com:8080/api'),
    AJAX_MOCK_PARAM: JSON.stringify('mock-file'),
    USER_INFO_URL: JSON.stringify('/user'),
    BKPAAS_APP_ID: JSON.stringify('tencentapp1'),
    LOGIN_URL: JSON.stringify('https://login.o.tencent.com')
})
